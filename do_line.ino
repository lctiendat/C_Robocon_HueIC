...
void doc_cam_bien_do_line(int huong_cb)
{
  ...
  if(huong_cb == cb_truoc_sau) //đọc 6 cảm biến trước và 6 cảm biến sau
  {
    ...
    sensor1[0]=digitalRead(22);
    sensor1[1]=digitalRead(23);
    sensor1[2]=digitalRead(24);
    sensor1[3]=digitalRead(25);
    sensor1[4]=digitalRead(26);
    sensor1[5]=digitalRead(27);
  }
